...
namespace Hongyu.framework.Common.InitCore
{
    public  class AutofacModuleRegister: Autofac.Module
    {
        ...
        {
            //注册Service
            var assemblysServices = Assembly.Load("Hongyu.framework.Application");
            ...
            //注册Repository
            var assemblysRepository = Assembly.Load("Hongyu.framework.Repositories");
            ...
            //注册Repository
            var assemblysCommon = Assembly.Load("Hongyu.framework.Common");
